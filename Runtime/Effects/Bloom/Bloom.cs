...
namespace NaninovelPostProcess
{
    ...
    public class Bloom : PostProcessSpawnObject, Spawn.IParameterized, Spawn.IAwaitable, DestroySpawned.IParameterized, DestroySpawned.IAwaitable, PostProcessSpawnObject.ITextureParameterized
    {
        ...
        {
            if (duration > 0) await intensityTweener.RunAwaitable(new FloatTween(bloom.intensity.value, intensity, duration, x => bloom.intensity.value = x, IgnoreTimescale), asyncToken, bloom);
        ...
        {
            if (duration > 0) await thresholdTweener.RunAwaitable(new FloatTween(bloom.threshold.value, threshold, duration, x => bloom.threshold.value = x, IgnoreTimescale), asyncToken, bloom);
        ...
        {
            if (duration > 0) await softKneeTweener.RunAwaitable(new FloatTween(bloom.softKnee.value, softKnee, duration, x => bloom.softKnee.value = x, IgnoreTimescale), asyncToken, bloom);
        ...
        {
            if (duration > 0) await clampTweener.RunAwaitable(new FloatTween(bloom.clamp.value, clamp, duration, x => bloom.clamp.value = x, IgnoreTimescale), asyncToken, bloom);
        ...
        {
            if (duration > 0) await diffusionTweener.RunAwaitable(new FloatTween(bloom.diffusion.value, diffusion, duration, x => bloom.diffusion.value = x, IgnoreTimescale), asyncToken, bloom);
        ...
        {
            if (duration > 0) await anamorphicRatioTweener.RunAwaitable(new FloatTween(bloom.anamorphicRatio.value, anamorphicRatio, duration, x => bloom.anamorphicRatio.value = x, IgnoreTimescale), asyncToken, bloom);
        ...
        {
            if (duration > 0) await tintTweener.RunAwaitable(new ColorTween(bloom.color.value, tint, ColorTweenMode.All, duration, x => bloom.color.value = x, IgnoreTimescale), asyncToken, bloom);
        ...
        {
            if (duration > 0) await dirtIntensityTweener.RunAwaitable(new FloatTween(bloom.dirtIntensity.value, dirtIntensity, duration, x => bloom.dirtIntensity.value = x, IgnoreTimescale), asyncToken, bloom);
