...
namespace NaninovelPostProcess { 
    ...
    public class ColorGradingHDR : PostProcessSpawnObject, Spawn.IParameterized, Spawn.IAwaitable, DestroySpawned.IParameterized, DestroySpawned.IAwaitable
    {
        ...
        {
            if (duration > 0) await toeStrengthTweener.RunAwaitable(new FloatTween(colorGrading.toneCurveToeStrength.value, toeStrength, duration, x => colorGrading.toneCurveToeStrength.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await toeLengthTweener.RunAwaitable(new FloatTween(colorGrading.toneCurveToeLength.value, toeLength, duration, x => colorGrading.toneCurveToeLength.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await shoulderStrengthTweener.RunAwaitable(new FloatTween(colorGrading.toneCurveShoulderStrength.value, shoulderStrength, duration, x => colorGrading.toneCurveShoulderStrength.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await shoulderLengthTweener.RunAwaitable(new FloatTween(colorGrading.toneCurveShoulderLength.value, shoulderLength, duration, x => colorGrading.toneCurveShoulderLength.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await shoulderAngleTweener.RunAwaitable(new FloatTween(colorGrading.toneCurveShoulderAngle.value, shoulderAngle, duration, x => colorGrading.toneCurveShoulderAngle.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await toneGammaTweener.RunAwaitable(new FloatTween(colorGrading.toneCurveGamma.value, toneGamma, duration, x => colorGrading.toneCurveGamma.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await temperatureTweener.RunAwaitable(new FloatTween(colorGrading.temperature.value, temperature, duration, x => colorGrading.temperature.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await tintTweener.RunAwaitable(new FloatTween(colorGrading.tint.value, tint, duration, x => colorGrading.tint.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await postExposureTweener.RunAwaitable(new FloatTween(colorGrading.postExposure.value, postExposure, duration, x => colorGrading.postExposure.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await colorFilterTweener.RunAwaitable(new ColorTween(colorGrading.colorFilter.value, colorFilter, ColorTweenMode.All, duration, x => colorGrading.colorFilter.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await hueShiftTweener.RunAwaitable(new FloatTween(colorGrading.hueShift.value, hueShift, duration, x => colorGrading.hueShift.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await saturationTweener.RunAwaitable(new FloatTween(colorGrading.saturation.value, saturation, duration, x => colorGrading.saturation.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await contrastTweener.RunAwaitable(new FloatTween(colorGrading.contrast.value, contrast, duration, x => colorGrading.contrast.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await redChannelTweener.RunAwaitable(new VectorTween(GetRedChannel(), red, duration, ApplyRedChannel), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await greenChannelTweener.RunAwaitable(new VectorTween(GetGreenChannel(), green, duration, ApplyGreenChannel), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await blueChannelTweener.RunAwaitable(new VectorTween(GetBlueChannel(), blue, duration, ApplyBlueChannel), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await liftTweener.RunAwaitable(new VectorTween(colorGrading.lift.value, lift, duration, x => colorGrading.lift.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await gammaTweener.RunAwaitable(new VectorTween(colorGrading.gamma.value, gamma, duration, x => colorGrading.gamma.value = x, IgnoreTimescale), asyncToken, colorGrading);
        ...
        {
            if (duration > 0) await gainTweener.RunAwaitable(new VectorTween(colorGrading.gain.value, gain, duration, x => colorGrading.gain.value = x, IgnoreTimescale), asyncToken, colorGrading);
