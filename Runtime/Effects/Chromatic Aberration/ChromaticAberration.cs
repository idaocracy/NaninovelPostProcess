...
namespace NaninovelPostProcess { 
    ...
    public class ChromaticAberration : PostProcessSpawnObject, Spawn.IParameterized, Spawn.IAwaitable, DestroySpawned.IParameterized, DestroySpawned.IAwaitable, PostProcessSpawnObject.ITextureParameterized
    {
        ...
        {
            if (duration > 0) await intensityTweener.RunAwaitable(new FloatTween(chromaticAberration.intensity.value, Intensity, duration, x => chromaticAberration.intensity.value = x, IgnoreTimescale), asyncToken, chromaticAberration);
